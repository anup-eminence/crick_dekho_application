...
/*
* Not Using this adapter for now
* Keep this for feature update
* may be required not sure
*
* */

class CommentaryAdapter :
    ListAdapter<Commentary, CommentaryAdapter.CommentaryVH>(CategoryMainDiffUtils()) {

    class CategoryMainDiffUtils : DiffUtil.ItemCallback<Commentary>() {
        override fun areItemsTheSame(oldItem: Commentary, newItem: Commentary): Boolean {
            return oldItem._id == newItem._id
        }

        override fun areContentsTheSame(oldItem: Commentary, newItem: Commentary): Boolean {
